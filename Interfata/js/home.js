...
function GenerateQuestion(){
	...
	question_generator=setTimeout(GenerateQuestion, 2*time_to_question)
}

function SendUserMessage(){
	clearTimeout(question_generator);
	question_generator=setTimeout(GenerateQuestion, time_to_question);
